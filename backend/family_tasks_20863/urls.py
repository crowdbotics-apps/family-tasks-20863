"""family_tasks_20863 URL Configuration
...
admin.site.site_header = "Family tasks"
admin.site.site_title = "Family tasks Admin Portal"
admin.site.index_title = "Family tasks Admin"

# swagger
api_info = openapi.Info(
    title="Family tasks API",
    default_version="v1",
    description="API documentation for Family tasks App",
)
